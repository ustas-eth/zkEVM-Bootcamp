...
echo "Let's get you set up with Zustlings!"
...
Path=${1:-zustlings/}
echo "Cloning Zustlings at $Path..."
...
then
    ...
    then
        ...
        echo "Zustlings will be installed using the main branch"
        Version="main"
    else
...
echo "Installing the 'zustlings' executable..."
cargo install --force --path .

if ! [ -x "$(command -v zustlings)" ]
then
...
echo "All done! Run 'zustlings' to get started."
