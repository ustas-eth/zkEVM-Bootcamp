...
#Requires -Version 5
param($path = "$pwd/zustlings")

Write-Host "Let's get you set up with Zustlings!"
...
Write-Host "Cloning Zustlings at $path"
...
Write-Host "Installing the 'zustlings' executable..."
cargo install --force --path .
if (!(Get-Command zustlings -ErrorAction SilentlyContinue)) {
...
Write-Host "All done! Run 'zustlings' to get started."
